...
final class LoadStatusResolverTests: XCTestCase {
    ...
    func testStatusAndFilterUseChineseDisplayNames() {
        ...
        XCTAssertEqual(StartupFilter.loginItems.title, "Login Items")
        XCTAssertEqual(StartupFilter.backgroundTasks.title, "Background Tasks")
        XCTAssertEqual(StartupFilter.smAppServices.title, "SMAppService")
